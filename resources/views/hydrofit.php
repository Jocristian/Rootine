...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
    ...
    <div class="kategori-tanaman">HYDROFIT (TANAMAN AIR)</div>
    <div class="container-produk">  
      <div class="card">
        <a href="pages/padi">
          <img src="images/tanaman/padi.jpg" /></a>
        <div class="intro">
          <h1>Padi</h1>
          <p>Tanaman pangan utama di dunia dan merupakan sumber makanan pokok yaitu beras</p>
        </div>
      </div>

      <div class="card">
        <a href="pages/pakcoyair">
          <img src="images/tanaman/pokcoyair.jpg" /></a>
        <div class="intro">
          <h1>Pakcoy Air</h1>
          <p>Tanaman dengan batang tebal berair yang kayak akan mineral
          </p>
        </div>
      </div>
    </div>
