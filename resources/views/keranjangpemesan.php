<?php
    ...
    $options = array(
        CURLOPT_URL => 'https://us-east-1.aws.data.mongodb-api.com/app/application-0-rjiyx/endpoint/getPesananByUsername?username='.$_SESSION['username'],
...
<div class="container">
    <h1 style="color:#435334;font-weight:bold;margin-top:10%" class="text-center">Pesananku</h1>
    <!-- -->
    ...
    <table class="table table-bordered border-black" style="margin-top:5%">
                <thead>
                    ...
                    <th style="background-color: #9EB384;color:white;text-align:center;justify-content:center">Nama Produk</th>
                    <th style="background-color: #9EB384;color:white;text-align:center;justify-content:center">Alamat Pengiriman</th>
                    ...
                    <?php
                        ...
                        foreach ($data as $row):
                            echo '<tr>
                                ...
                                <td style="padding:50px;">' . (isset($row->nama) ? $row->nama : '') . '</td>
                                <td style="padding:50px;">' . (isset($row->alamat) ? $row->alamat : '') . '</td>
