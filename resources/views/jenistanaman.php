...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
    ...
    <div class="container-produk">  
      <div class="card">
        <a href="/xerofit">
          <img src="images/tanaman/Xerofit.jpg" /></a>
        <div class="intro">
          <h1>Xerofit</h1>
          <p>Jenis tumbuhan yang telah beradaptasi dengan lingkungan kering atau gersang</p>
        </div>
      </div>

      <div class="card">
        <a href="/higrofit">
            <img src="images/tanaman/Higrofit.jpg" /></a>
        <div class="intro">
          <h1>Higrofit</h1>
          <p>Jenis tumbuhan yang tumbuh di lingkungan yang lembap
          </p>
        </div>
      </div>
      ...
      <div class="card">
        <a href="/hydrofit">
            <img src="images/tanaman/Hydrofit.jpg" /></a>
        <div class="intro">
          <h1>Hydrofit</h1>
          <p>Jenis tumbuhan yang tumbuh dengan iklim tanah yang berair</p>
        </div>
      </div>
    </div>
      <!-- <div class="card">
