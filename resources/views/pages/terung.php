...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="Tanaman" style="text-align: center;">
        <img src="../images/tanaman/terung.jpg" style="width: 300px; height: 300px; margin-top: 10%;">
        <div class="judul-tanaman pt-3">
            <h2><b>Terung</b></h2>
        </div>
        <div class="nama-latin">
            <p> 
                <h3><b>(Solanum melongena)</b></h3>
            </p>
        </div>
        <div class="container" style="text-align: left;">
          ...
          <div class="penjelasan-tanaman">
              <h3>Deskripsi</h3>
              Terung(Solanum melongena),Terung ialah terna yang sering ditanam secara tahunan.
              Tanaman ini tumbuh hingga 40–150 cm (16-57 inci) tingginya. Daunnya besar, dengan lobus yang kasar.
              Ukurannya 10–20 cm (4-8 inci) panjangnya dan 5–10 cm (2-4 inci) lebarnya. Jenis-jenis setengah liar lebih besar dan 
              tumbuh hingga setinggi 225 cm (7 kaki), dengan daun yang melebihi 30 cm (12 inci) dan 15 cm (6 inci) panjangnya.
              Batangnya biasanya berduri. Warna bunganya antara putih hingga ungu, dengan mahkota yang memiliki lima lobus.
          ...
          <div class="budidaya">
              ...
              <ul>
                  <li>Pemilihan lahan<br>Pilih lokasi yang terkena sinar matahari penuh atau setidaknya 6-8 jam sinar matahari per hari.
                      Terung tumbuh baik di dataran rendah hingga sedang.</li><br>
                  <li>Jenis tanah<br>Terung tumbuh dengan baik pada tanah yang gembur, subur, dan memiliki drainase yang baik.
                  </li><br>
                  <li>Suhu<br>
                      Sesuaikan suhu daerah anda dengan suhu tanam benih terung, yakni 22oC – 30oC, perhatikan musim, musim yang ideal untuk menanam 
                      terung adalah berkisar pada awal musim kemarau yakni bulan Maret atau April, dan 
                      pada awal musim penghujan yakni pada bulan Oktober atau November.</li><br>
                  <li>Ph tanah <br>
                      Tanah yang sedikit asam hingga netral dengan pH sekitar 6 hingga 7 adalah yang terbaik.</li><br>
                  <li>Kelembapan<br>
                      Pastikan tanah tetap lembab selama fase pertumbuhan. Terung memerlukan kelembaban yang cukup.
                  </li><br>
                  <li>Penanaman benih<br>
                      Tanam benih terung dengan kedalaman sekitar 0,5 cm hingga 1 cm dan jarakkan antarbenih yang sesuai tergantung pada varietas.</li><br>
                  <li>Pengairan<br>
                      Tanaman membutuhkan air sebagai sumber makanan dan membantu mereka dalam proses fotosintesis, tanaman
                      terung hendaknya disiram rutin namun tidak berlebihan, yakni pada pagi dan sore hari.</li><br>
                  <li>Pencahayaan<br>
                      Terung memerlukan sinar matahari untuk pertumbuhan yang baik sekitar 6 - 8 jam.</li><br>
              </ul>
          </div>
          <div class="hama">
              <h3>Hama</h3>
              <p></p>
              <ul>
                  <li>Lalat bauh(Drosophila melanogaster)<br>
                      Hama ini akan mengakibatkan terong berwarna coklat dan kemudian menjadi busuk, apabila terong 
                      dibelah maka akan terdapat larva lalat di dalamnya.</li><br>
                  <li> Kutu Daun(Aphidoidea)<br>Kutu daun akan menyebabkan kerusakan pada daun-daun muda, 
                      sehingga proses pertumbuhan dan pembuahan terhambat.</li><br>
              </ul>
          </div>
          <div class="penyakit">
              <h3>Penyakit</h3>
              <p></p>
              <ul>
                  <li>Penyakit patek(Antraknosa)  <br>
                      Gejala penyakit antraknosa adalah kulit buah terung akan tampak mengilap,
                        selanjutnya akan timbul bercak hitam yang kemudian meluas dan akhirnya membusuk.</li><br>
                  <li> Penyakit busuk buah<br>Disebabkan oleh jamur Pythoptora. Gejala serangan jamur Pythoptora yaitu terdapat bercak-bercak pada buah, dan lama kelamaan buah menjadi busuk.</li><br>
              </ul>
          </div>
        </div>
    </div>
