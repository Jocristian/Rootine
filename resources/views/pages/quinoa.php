...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="Tanaman" style="text-align: center;">
        <img src="../images/tanaman/quinoa.jpg" style="width: 300px; height: 300px; margin-top: 10%;">
        <div class="judul-tanaman pt-3">
            <h2><b>Quinoa</b></h2>
        </div>
        <div class="nama-latin">
            <p> 
                <h3><b>(Chenopodium quinoa)</b></h3>
            </p>
        </div>
        <div class="container" style="text-align: left;">
          ...
          <div class="penjelasan-tanaman">
              <h3>Deskripsi</h3>
              Quinoa (Chenopodium quinoa) adalah tanaman biji-bijian yang berasal dari Amerika Selatan.
              Biji quinoa kecil, kaya akan protein, serat, dan nutrisi.
              Tanaman ini tahan terhadap kondisi cuaca yang ekstrem dan merupakan sumber makanan yang berharga.
          ...
          <div class="budidaya">
              ...
              <p></p>
              <ul>
                  <li>Pemilihan lahan<br> Pilih lahan yang terkena sinar matahari penuh. Quinoa tumbuh paling baik pada tanah yang memiliki drainase yang baik dan gembur.</li><br>
                  <li>Jenis tanah<br> Tanah loam yang gembur adalah yang terbaik untuk quinoa. Pastikan tanah memiliki pH sekitar 6 hingga 8</li><br>
                  <li>Suhu<br>
                      Quinoa tumbuh dengan baik pada suhu antara 15°C hingga 25°C (59-77°F). Ini adalah tanaman yang tahan suhu dingin hingga suhu panas.</li><br>
                  <li>Ph tanah <br>
                      Quinoa tumbuh optimal pada tanah dengan pH sekitar 6 hingga 8, yang cenderung netral hingga sedikit alkalis. </li><br>
                  <li>Kelembapan<br>
                      Quinoa memerlukan kelembaban yang cukup selama fase pertumbuhan awal. Pastikan tanah tetap lembab, terutama saat benih ditanam.</li><br>
                  <li>Penanaman benih<br>
                      Tanamlah benih quinoa dengan kedalaman sekitar 2 cm dan jarakkan antarbenih sekitar 30 cm.</li><br>
                  <li>Pengairan<br>
                      Penyiraman teratur penting selama fase pertumbuhan. Pastikan tanaman mendapatkan air yang cukup, terutama saat benih baru ditanam.</li><br>
                  <li>Pencahayaan<br>
                      Quinoa memerlukan sinar matahari penuh untuk pertumbuhan yang baik.</li><br>
              </ul>
          </div>
          <div class="hama">
              <h3>Hama</h3>
              <p></p>
              <ul>
                  <li> Ulat bawang (Spodoptera exigua)<br>
                      Umumnya 2 hingga 3 generasi larva ulat bit muncul selama musim tanam.
                        Ulat ini dapat merusak bibit dengan memakan daun dan tangkai daun.</li><br>
                  <li>Ngengat angsa ( Scrobipalpa atriplicella )<br> Biasanya menyerang dua musim per tahun, ulat ngengat Goosefoot memakan dedaunan dan malai.
                        Jika tidak dikendalikan, hama ini dapat memusnahkan tanaman ini.</li><br>
              </ul>
          </div>
          <div class="penyakit">
              <h3>Penyakit</h3>
              <p></p>
              <ul>
                  <li>Bercak daun Passalora (Passalora dubia) <br>
                      Quinoa yang terserang jamur ini akan memiliki lesi berwarna gelap berbentuk oval dengan tepi berwarna coklat kemerahan yang muncul di daun
                  </li><br>
                  <li> Penyakit bulai ( Peronospora varias )<br>Disebabkan oleh jamur jelaga Gejala serangan pada permukaan atas daun tertutup oleh lapisan yang berwarna hitam, kering dan tipis.
