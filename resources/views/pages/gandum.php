...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="Tanaman" style="text-align: center;">
        <img src="../images/tanaman/gandum.jpg" style="width: 300px; height: 300px; margin-top: 10%;">
        <div class="judul-tanaman pt-3">
            <h2><b>Gandum</b></h2>
        </div>
        <div class="nama-latin">
            <p> 
                <h3><b>(Triticum aestivum)</b></h3>
            </p>
        </div>
        <div class="container" style="text-align: left;">
          ...
          <div class="penjelasan-tanaman">
              ...
              Gandum (Triticum spp.) adalah sekelompok tanaman serealia dari suku padi-padian yang kaya akan karbohidrat.
                ...
                Pada umumnya, biji gandum (kernel) berbentuk opal dengan panjang 6–8 mm dan diameter 2–3 mm.
                  Seperti jenis serealia lainnya, gandum memiliki tekstur yang keras.
          ...
          <div class="budidaya">
              ...
              <p></p>
              <ul>
                  <li>Pemilihan lahan<br>Pilih lokasi yang terkena sinar matahari penuh. Gandum tumbuh paling baik dengan sinar matahari yang cukup. Gandum tumbuh baik di dataran rendah hingga sedang.</li><br>
                  <li>Jenis tanah<br>  Gandum tumbuh dengan baik pada tanah yang gembur, subur,
                      dan memiliki drainase yang baik. Gandum memerlukan tanah yang cukup kaya akan bahan organik.</li><br>
                  <li>Suhu<br>
                    Gandum tumbuh dengan baik pada suhu sekitar 15°C hingga 24°C (59-75°F) selama fase pertumbuhan awal.</li><br>
                  <li>Ph tanah <br>
                    Gandum tumbuh dengan baik pada tanah yang memiliki pH sekitar 6 hingga 7, yang cenderung netral hingga sedikit asam.  </li><br>
                  <li>Kelembapan<br>
                    Gandum memerlukan kelembaban yang cukup selama fase pertumbuhan awal, tetapi tanaman ini lebih tahan kekeringan dibandingkan dengan beberapa tanaman lainnya.</li><br>
                  <li>Penanaman benih<br>
                    Tanam benih gandum dengan kedalaman sekitar 3-5 cm, dengan jarak tanam yang sesuai tergantung pada varietas.</li><br>
                  <li>Pengairan<br>
                    Gandum memerlukan penyiraman teratur selama fase pertumbuhan awal,
                      tetapi tidak memerlukan air berlebihan. Pastikan tanah tetap lembab, terutama selama fase pembentukan malai.</li><br>
                  <li>Pencahayaan<br>
                    Gandum memerlukan sinar matahari untuk pertumbuhan yang baik, tetapi juga tumbuh baik dalam kondisi cahaya sedang.</li><br>
              </ul>
          </div>
          <div class="hama">
              <h3>Hama</h3>
              <p></p>
              <ul>
                  <li>Belalang(subordo Caelifera )<br>
                    Menyerang gandum pada dataran rendah dan tinggi, dengan gejala seperti bekas gigitan berbentuk
                    sobekan tak beraturan sehingga menyebabkan daun habis menyisakan tulang daun.</li><br>
                  <li>Ulat Jengkal(Lepidoptera:Geometridae)<br> Menyerang gandum dataran tinggi , ulat jengkal menyerang bagian lamina pada daun.
                      Hama ini juga bisa disebabkan karena berdekatan dengan tanaman kentang.</li><br>
              </ul>
          </div>
          <div class="penyakit">
              <h3>Penyakit</h3>
              ...
              <ul>
                  <li>Belalang(subordo Caelifera )<br>
                    Menyerang gandum pada dataran rendah dan tinggi, dengan gejala seperti bekas gigitan berbentuk
                      sobekan tak beraturan sehingga menyebabkan daun habis menyisakan tulang daun.

                  </li><br>
                  <li> Bercak daun(Spot Blotch) <br>Ditemukan pada dataran tinggi di Dieng.
                      Gejala penyakit bercak ditandai dengan penyebaran bintik - bintik secara meluas menjadi bercak berwarna
                      coklat tua hingga menghitam dimana dapat menurunkan ketahanan tanaman.</li><br>
              </ul>
          </div>
        </div>
    </div>
