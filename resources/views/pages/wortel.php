...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="Tanaman" style="text-align: center;">
        <img src="../images/tanaman/wortel.jpg" style="width: 300px; height: 300px; margin-top: 10%;">
        <div class="judul-tanaman pt-3">
            <h2><b>Wortel</b></h2>
        </div>
        <div class="nama-latin">
            <p> 
                <h3><b>(Daucus carota subsp. sativus)</b></h3>
            </p>
        </div>
        <div class="container" style="text-align: left;">
          ...
          <div class="penjelasan-tanaman">
              <h3>Deskripsi</h3>
              Wortel (Daucus carota subsp. sativus), berwarna orange dan berbentuk seperti kerucut kurus dan memanjang,
                Batang bunga tumbuh setinggi sekitar 1 m, dengan bunga berwarna putih, dan rasa yang manis langu.
          ...
          <div class="budidaya">
              ...
              <p></p>
              <ul>
                  <li>Pemilihan lahan<br>Wilayah yang sangat baik untuk budidaya wortel adalah wilayah yang memiliki iklim basah dengan
                        durasi kering hanya 1,5 bulan sampai 3 bulan dalam 1 tahun. Selain itu, menanam wortel bisa juga
                        dilakukan di iklim yang agak basah dengan durasi kering hanya 3-4,5 bulan dalam 1 tahun.</li><br>
                  <li>Jenis tanah<br>Jenis tanah untuk penanaman seperti Aluvial , Andosol,latosol,dan regosol.Tanah dengan jenis tersebut bisa ditemui di dataran tinggi.
                  </li><br>
                  <li>Suhu<br>
                      Proses metabolisme wortel sangat dipengaruhi oleh suhu, agar tanaman 
                      wortel bisa berkembang secara optimal, kamu harus menanam wortel di lahan dengan suhu 15,6-21,1 C.</li><br>
                  <li>Ph tanah <br>
                      Tingkat keasaman tanah yang dibutuhkan adalah sekitar 5,5-6,5 pH.</li><br>
                  <li>Kelembapan<br>
                      Kelembaban udara yang disarankan untuk menanam wortel berada di kisaran 80-90%.
                  </li><br>
                  <li>Penanaman benih<br>
                      Tanam benih wortel dengan kedalaman sekitar 1 cm dan jarakkan antarbenih yang sesuai tergantung pada varietas.</li><br>
                  <li>Pengairan<br>
                      Penyiraman teratur penting selama fase pertumbuhan. Pastikan tanaman mendapatkan air yang cukup, terutama selama pembentukan akar.</li><br>
                  <li>Pencahayaan<br>
                      Usahakan wortel mendapatkan cahaya matahari selama 9 hingga 10 jam setiap harinya supaya
                        pertumbuhannya bisa lebih optimal.</li><br>
              </ul>
          </div>
          <div class="hama">
              <h3>Hama</h3>
              <p></p>
              <ul>
                  <li>Ulat tanah ( Agrotis ipsilon Hufn )<br>
                      Ulat tanah memiliki warna kecoklatan hingga hitam dengan panjang sekitar 4-5 cm dan hidup di dalam tanah.
                        Gejala yang ditimbulkan dari ulat tanah yaitu dengan menyerang bagian pucuk yang masih muda hingga mengakibatkan tanaman menjadi layu, kering dan mati.</li><br>
                  <li> Lalat atau magot ( Psile rosae )<br> Lalat ini memiliki warna tubuh kehitaman dan kehijauan, 
                      terdapat belang pada tubuh yang berwarna coklat muda dan hitam. Lalat akan menyerang buah 
                      hingga berlubang dan membusuk pada bagian dalam hingga menyebabkan buah tidak normal.
                  </li><br>
              </ul>
          </div>
          <div class="penyakit">
              ...
              <p></p>
              <ul>
                  <li>Busuk Alternaria(Cendawan alternaria dauci Khun)<br>
                      Timbul bercak pada daun atau bintik kecil berwarna coklat tua hingga kehitaman, 
                      serta membuat daun layu dan mengering.</li><br>
                  <li> Bercak daun(Cendawan cercospora)<br>Terdapat bercak berwarna kehitaman atau kecoklatan pada permukaan daun tua.</li><br>
              </ul>
          </div>
        </div>
    </div>
