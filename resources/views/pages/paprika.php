...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="Tanaman" style="text-align: center;">
        <img src="../images/tanaman/paprika.jpg" style="width: 300px; height: 300px; margin-top: 10%;">
        <div class="judul-tanaman pt-3">
            <h2><b>Paprika</b></h2>
        </div>
        <div class="nama-latin">
            <p> 
                <h3><b>(Capsicum annuum L)</b></h3>
            </p>
        </div>
        <div class="container" style="text-align: left;">
          ...
          <div class="penjelasan-tanaman">
              <h3>Deskripsi</h3>
              Buahnya yang berwarna hijau, kuning, merah, atau ungu. Tanaman paprika umumnya tumbuh setinggi 50 cm - 150 cm. 
              Buah paprika umumnya memiliki rasa manis hingga pedas dan digunakan dalam berbagai hidangan.
          </div>
          <div class="budidaya">
              ...
              <ul>
                  <li>Pemilihan lahan<br>Pilih lokasi yang terkena sinar matahari penuh atau setidaknya 6-8 jam sinar matahari per hari.
                      Paprika cocok dibudidayakan didataran tinggi, dengan ketinggian >1000 mdpl.</li><br>
                  <li>Jenis tanah<br>Paprika tumbuh dengan baik pada tanah yang gembur, subur, dan memiliki drainase yang baik. </li><br>
                  <li>Suhu<br>
                      Paprika tumbuh dengan baik pada suhu sekitar 21°C hingga 29°C (70-84°F) selama fase pertumbuhan awal.</li><br>
                  <li>Ph tanah <br>
                      Tanah yang sedikit asam hingga netral dengan pH sekitar 6 hingga 7,5 adalah yang terbaik.</li><br>
                  <li>Kelembapan<br>
                      Pastikan tanah tetap lembab selama fase pertumbuhan. Paprika memerlukan kelembaban yang cukup.
                  </li><br>
                  <li>Penanaman benih<br>
                      Tanam benih paprika dengan kedalaman sekitar 0,5 cm hingga 1 cm dan jarakkan antarbenih yang sesuai tergantung pada varietas.</li><br>
                  <li>Pengairan<br>
                  ...
                  <li>Pencahayaan<br>
                      Paprika memerlukan sinar matahari untuk pertumbuhan yang baik.sekitar 6 - 8 jam.</li><br>
              </ul>
          </div>
          <div class="hama">
              <h3>Hama</h3>
              <p></p>
              <ul>
                  <li>Lalat buah(Drosophila melanogaster)<br>
                      Hama ini akan mengakibatkan paprika berwarna coklat dan kemudian menjadi busuk,
                        apabila paprika dibelah maka akan terdapat larva lalat di dalamnya.</li><br>
                  <li> Ulat grayak (Spodoptera litura)<br> Gejala: ulat menyerang daun hingga habis daunnya
          ...
          <div class="penyakit">
              ...
              <ul>
                  <li>Hama trips<br>
                      seringkali bersembunyi di sisa mahkota bunga paprika.
                        Oleh karena itu, Anda harus membuang sisa mahkota bunga yang sudah terbentuk.</li><br>
                  <li>busuk buah <br>Disebabkan oleh jamur Pythoptora.
                        Gejala serangan jamur Pythoptora yaitu terdapat bercak-bercak pada buah, dan lama kelamaan buah menjadi busuk.</li><br>
              </ul>
          </div>
        </div>
    </div>
