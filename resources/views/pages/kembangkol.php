...
<html lang="en">
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="Tanaman" style="text-align: center;">
        <img src="../images/tanaman/kembangkol.jpg" style="width: 300px; height: 300px; margin-top: 10%;">
        <div class="judul-tanaman pt-3">
            <h2><b>Kembang kol</b></h2>
        </div>
        <div class="nama-latin">
            <p> 
                <h3><b>(Brassica oleracea var. botrytis)</b></h3>
            </p>
        </div>
        <div class="container" style="text-align: left;">
          ...
          <div class="penjelasan-tanaman">
              <h3>Deskripsi</h3>
              Kembang kol merupakan tumbuhan yang termasuk dalam kelompok botrytis dari jenis Brassica oleracea (suku Brassicaceae).
              Kembang kol berasal dari Mediterania.
              Ciri kembang kol pada dasar kepala terdapat daun-daun hijau yang tebal dan tersusun rapat dan
              memiliki kepala bunga yang banyak dan teratur dengan padat.
          ...
          <div class="budidaya">
              ...
              <ul>
                  <li>Pemilihan lahan<br> Pilih lokasi yang terkena sinar matahari penuh atau setidaknya 6-8 jam sinar matahari per hari.
                      Kembang kol tumbuh baik di dataran rendah hingga sedang.</li><br>
                  <li>Jenis tanah<br>  GKembang kol tumbuh dengan baik pada tanah yang gembur, subur, dan memiliki drainase yang baik.</li><br>
                  <li>Suhu<br>
                      Kembang kol tumbuh dengan baik pada suhu antara 15°C hingga 20°C (59-68°F) selama fase pertumbuhan awal.</li><br>
                  <li>Ph tanah <br>
                      Tanah yang sedikit asam hingga netral dengan pH sekitar 6 hingga 7,5 adalah yang terbaik.  </li><br>
                  <li>Kelembapan<br>
                      Pastikan tanah tetap lembab selama fase pertumbuhan. Kembang kol memerlukan kelembaban yang cukup.</li><br>
                  <li>Penanaman benih<br>
                      Tanamlah benih kembang kol dengan kedalaman sekitar 0,5 cm hingga 1 cm dan jarakkan antarbenih yang sesuai tergantung pada varietas.</li><br>
                  <li>Pengairan<br>
                      Penyiraman teratur penting selama fase pertumbuhan. Pastikan tanaman mendapatkan air yang cukup, terutama selama pembentukan kepala bunga.</li><br>
                  <li>Pencahayaan<br>
                      Kembang kol memerlukan sinar matahari untuk pertumbuhan yang baik sekitar 6 - 8 jam.</li><br>
              </ul>
          </div>
          <div class="hama">
              <h3>Hama</h3>
              <p></p>
              <ul>
                  <li> Kutu daun (Aphidoidea)<br>
                      Kutu daun adalah spesies serangga kecil pemakan getah tanaman.[1] Kutu daun hidup secara berkelompok (koloni), berwarna hitam, coklat atau hijau.
                      </li><br>
                  <li>Plutella xylostella<br> Menyerang tanaman saat fase larva (ulat).
                        Larva muda yang baru menetas menggorok daun kubis selama 2-3 hari. Setelah itu, larva memakan jaringan bagian permukaan bawah atau atas daun.
                        Hal ini meninggalkan lapisan tipis/transparan sehingga daun seperti berjendela.
                          Daun kemudian sobek dan membentuk lubang sehingga tersisa tulang-tulang daun. Serangan berat hama ini biasanya terjadi pada musim kemarau.
                      </li><br>
              </ul>
          </div>
          <div class="penyakit">
              ...
              <ul>
                  <li>Busuk Hitam<br>
                      Penyakit busuk hitam disebabkan bakteri Xanthomonas camprestis Dows. Saat tanaman kembang kol terkena, penyakit busuk hitam akan bersifat tular benih (seed born), menyerang pada semua fase pertumbuhan.
                        Mulai dari persemaian hingga menjelang panen. Gejalanya, terdapat bercak coklat kehitam-hitaman pada daun, batang, tangkai, bunga maupun massa bunga kol.
                        Batang dan massa bunga kol menjadi busuk sehingga tidak dapat dipanen. Kondisi lingkungan yang mendukung bakteri dan proses infeksi adalah kelembaban dan suhu tinggi di kisaran 25-30 °C. 
                  </li><br>
                  <li> Penyakit busuk lunak<br>Disebabkan bakteri Erwinia carotovora Holland. Infeksi terjadi setelah busuk lunak melalui luka pada pangkal bunga yang hampir dipanen atau melalui akar yang terluka.
                      Gelajanya, mulanya dari bintik-bintik basah yang terbentuk. Kemudian, membesar dan menjadi cekung dan lunak.
                        Jaringan tanaman di bawah bintik-bintik menjadi lembek dan berubah warna, dari krem menjadi hitam. Pada infeksi yang parah, daun, batang dan akar dapat membusuk seluruhnya. Tercium bau tidak enak.</li><br>
              </ul>
          </div>
        </div>
    </div>
