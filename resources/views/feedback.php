    <?php
        ...
        $options = array(
            CURLOPT_URL => 'https://us-east-1.aws.data.mongodb-api.com/app/application-0-rjiyx/endpoint/getallfeedback',
    ...
    <div class="container">
        ...
        <table class="table table-bordered border-black" style="margin-top:5%">
                    <thead>
                        ...
                        <th style="background-color: #9EB384;color:white;text-align:center;justify-content:center">ID</th>
                        <th style="background-color: #9EB384;color:white;text-align:center;justify-content:center">Feedback</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            ...
                            foreach ($data as $row):
                                echo '<tr>
                                    ...
                                    <td style="padding:50px;">' . (isset($row->feedback) ? $row->feedback : '') . '</td>
                                </tr>';
                                $nomor++;
                            endforeach;
                        ?>
