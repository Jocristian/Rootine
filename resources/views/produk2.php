...
<html lang="en">
  <head>
    ...
    />
    <!-- Animate.css -->
    <link rel="stylesheet" href="aset/animate.css">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="aset/bootstrap.css">
    <!-- Flexslider  -->
    <link rel="stylesheet" href="aset/flexslider.css">
    <!-- Theme style  -->
  ...
  <body style="background-color: #fffaf2">
      ...
      <div class="nav-container">
        ...
        <div class="items">
          ...
          <ul class="p-0 m-0 nav-list">
            ...
            <li>
              <a href="tanaman.php" class="nav-link" id="link-tanaman"
                >Tanaman</a
              >
            </li>
            <li>
    ...
    if(! empty ($_SESSION)){
      if($_SESSION['username'] == 'admin'){
        ...
        ' <div class="chat active" style="cursor: pointer;bottom:175px;">
          ...
          <span><a href="keranjang.php"><i class="fa-solid fa-receipt" style="color: #fff;"></i></a></span>
          </div>';
      }else{
          echo
          '
          <div class="chat active" style="cursor: pointer;">
          <span><a href="keranjangpemesan.php"><i class="fa-solid fa-receipt" style="color: #fff;"></i></a></span>
          </div>';
      }
    }        
    ?>
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(aset/images/tanaman/bayam.jpg);">
		   			...
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
			   					...
			   					<p><a href="single.html" class="btn btn-primary btn-outline btn-lg">Selengkapnya</a></p>
		   					</div>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		   	<li style="background-image: url(aset/images/tanaman/newBrocoli.jpg);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   	...
		   	<li style="background-image: url(aset/images/tanaman/kembangkol.jpg);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   	...
		   	<li style="background-image: url(aset/images/tanaman/newCorn.jpg);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 text-center">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						<span class="icon">
							<i class="fa-light fa-oil-can-drip"></i>
						</span>
						<h3>Vitamin</h3>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove</p>
					</div>
                    ...
                    if(! empty($_SESSION['username'])){
                      foreach($data as $produk):
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="product">
                                <div class="product-grid" style="background-image:url(aset/images/produk/'.$produk->foto.');">
                                </div>
                                <div class="desc">
                          ...
                          <div class="col d-none" id="form'.$produk->PID.'">
                            <Form id="formPesanan'.$produk->PID.'" data-value="'.$produk->PID.'" action="savepesanan.php" method="get">
                                <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background-color:#FFFAF2">
                    <Form id="formupload" method="post" enctype="multipart/form-data" action="saveproduk.php">
    ...
    <footer class="body bg-coklat">
      ...
      <script src="aset/produk.js"></script>  
    <script src="js/scripts.js"></script>
    
    <!-- jQuery Easing -->
	<script src="aset/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="aset/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="aset/jquery.waypoints.min.js"></script>
	<!-- Carousel -->
	<!-- countTo -->
	<!-- Flexslider -->
	<script src="aset/jquery.flexslider-min.js"></script>
	<!-- Main -->
